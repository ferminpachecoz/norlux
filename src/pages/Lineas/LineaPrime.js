...
export default function LineaPrime() {
  let array=[
    ...
    {
      icon: "/LineaPrime/icons/window-2.webp",
  ...
  const images=[
    "/LineaPrime/image-banner-3.webp",
    "/LineaPrime/image-banner-4.webp",
    "/LineaPrime/image-banner-5.webp",
  ]
  const ITEMS=[
    {
      image: "/LineaPrime/productos/LP_2G_FINAL_BLANCO.webp",
      title: "blanco"
    },
    {
      image: "/LineaPrime/productos/LP_2G_GG_GRIS_GRAFITO.webp",
      title: "gris grafito"
    },
    {
      image: "/LineaPrime/productos/LP_2G_GMET_2.webp",
      title: "gris metalizado"
    },
    {
      image: "/LineaPrime/productos/LP_2G_JB.webp",
      title: "jet black"
    },
    {
      image: "/LineaPrime/productos/LP_2G_PELTRE.webp",
      title: "peltre"
    },
  ]
  return (
    <>
      ...
      <HeroSection 
        ...
        image="/LineaPrime/image-banner.webp" 
      />
      <Productos padding="0px">
        <div className='section-padding'>
          ...
          <img 
            src="/LineaPrime/image-banner-2.webp" 
        ...
        />
        <ImageBg image="/LineaPrime/image-banner-2.webp">
        ...
        <div className='section-padding'>
          ...
          <img src="/LineaPrime/prime-renders.webp" alt="prime renders" />
          ...
          <img src="/LineaPrime/prime-guias-2-3-guias.webp" alt="Prime guias 2 y 3" />
          <h3>Nueva hoja <b>Prime 74</b></h3>
          <p>Hoja más liviana para ventanas más chicas.</p>
          <img src="/LineaPrime/prime-74.webp" alt="Prime 74" />
